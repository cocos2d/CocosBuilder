...
TPRect MaxRectsBinPack::Insert(int width, int height, FreeRectChoiceHeuristic method)
{
	TPRect newNode;
...
void MaxRectsBinPack::PlaceRect(const TPRect &node)
{
	size_t numRectanglesToProcess = freeRectangles.size();
	for(size_t i = 0; i < numRectanglesToProcess; ++i)
	{
...
TPRect MaxRectsBinPack::ScoreRect(int width, int height, FreeRectChoiceHeuristic method, int &score1, int &score2, int idx) const
{
	TPRect newNode;
    ...
    newNode.rotated = (width != newNode.width);
    newNode.idx = idx;
...
TPRect MaxRectsBinPack::FindPositionForNewNodeBottomLeft(int width, int height, int &bestY, int &bestX) const
{
	TPRect bestNode;
	memset(&bestNode, 0, sizeof(TPRect));
...
TPRect MaxRectsBinPack::FindPositionForNewNodeBestShortSideFit(int width, int height,
...
TPRect MaxRectsBinPack::FindPositionForNewNodeBestLongSideFit(int width, int height,
	int &bestShortSideFit, int &bestLongSideFit) const
{
	TPRect bestNode;
	memset(&bestNode, 0, sizeof(TPRect));
...
TPRect MaxRectsBinPack::FindPositionForNewNodeBestAreaFit(int width, int height,
...
TPRect MaxRectsBinPack::FindPositionForNewNodeContactPoint(int width, int height, int &bestContactScore) const
{
	TPRect bestNode;
	memset(&bestNode, 0, sizeof(TPRect));
...
bool MaxRectsBinPack::SplitFreeNode(TPRect freeNode, const TPRect &usedNode)
{
