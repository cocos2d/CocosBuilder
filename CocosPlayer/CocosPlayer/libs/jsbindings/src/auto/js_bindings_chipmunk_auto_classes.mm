...
* Generated by "generate_js_bindings.py -c chipmunk_jsb.ini" on 2012-10-11
* Script version: v0.3
*/
...
JSBool JSB_cpConstraint_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	JSB_PRECONDITION3(NO, cx, JS_TRUE, "No constructor");
...
// Arguments: 
// Ret value: cpSpace*
JSBool JSB_cpSpace_alloc(JSContext *cx, uint32_t argc, jsval *vp) {
	JSB_PRECONDITION3( argc == 0, cx, JS_FALSE, "Invalid number of arguments" );
...
// Arguments: 
// Ret value: cpBody*
JSBool JSB_cpBody_alloc(JSContext *cx, uint32_t argc, jsval *vp) {
	JSB_PRECONDITION3( argc == 0, cx, JS_FALSE, "Invalid number of arguments" );
...
void JSB_cpBody_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("alloc", JSB_cpBody_alloc, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
