...
* Generated by "generate_js_bindings.py -c cocos2d_jsb.ini" on 2012-11-06
* Script version: v0.3
*/
...
JSBool JSB_CCDirector_convertEventToGL_(JSContext *cx, uint32_t argc, jsval *vp) {
...
void JSB_CCDirector_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("convertEventToGL", JSB_CCDirector_convertEventToGL_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		...
		JS_FN("isPaused", JSB_CCDirector_isPaused, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
...
JSClass* JSB_CCDirectorMac_class = NULL;
JSObject* JSB_CCDirectorMac_object = NULL;
// Constructor
JSBool JSB_CCDirectorMac_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
	JSObject *jsobj = [JSB_CCDirectorMac createJSObjectWithRealObject:nil context:cx];
	JS_SET_RVAL(cx, vp, OBJECT_TO_JSVAL(jsobj));
	return JS_TRUE;
}

// Destructor
void JSB_CCDirectorMac_finalize(JSFreeOp *fop, JSObject *obj)
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (CCDirectorMac)", obj);
//	JSB_NSObject *proxy = (JSB_NSObject*) jsb_get_proxy_for_jsobject(obj);
//	if (proxy) {
//		[[proxy realObj] release];
//	}
...
// Arguments: CGPoint
// Ret value: CGPoint ({CGPoint=ff})
JSBool JSB_CCDirectorMac_convertToLogicalCoordinates_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: BOOL (b)
JSBool JSB_CCDirectorMac_isFullScreen(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: CGSize ({CGSize=ff})
JSBool JSB_CCDirectorMac_originalWinSize(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: int (i)
JSBool JSB_CCDirectorMac_resizeMode(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: BOOL
// Ret value: void (None)
JSBool JSB_CCDirectorMac_setFullScreen_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: CGSize
// Ret value: void (None)
JSBool JSB_CCDirectorMac_setOriginalWinSize_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: int
// Ret value: void (None)
JSBool JSB_CCDirectorMac_setResizeMode_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: CCDirector* (o)
JSBool JSB_CCDirectorMac_sharedDirector_static(JSContext *cx, uint32_t argc, jsval *vp) {
	JSB_PRECONDITION3( argc == 0, cx, JS_FALSE, "Invalid number of arguments" );
	CCDirector* ret_val;
...
{
	JSB_CCDirectorMac_class = (JSClass *)calloc(1, sizeof(JSClass));
	JSB_CCDirectorMac_class->name = name;
	JSB_CCDirectorMac_class->addProperty = JS_PropertyStub;
	JSB_CCDirectorMac_class->delProperty = JS_PropertyStub;
	JSB_CCDirectorMac_class->getProperty = JS_PropertyStub;
	JSB_CCDirectorMac_class->setProperty = JS_StrictPropertyStub;
	JSB_CCDirectorMac_class->enumerate = JS_EnumerateStub;
	JSB_CCDirectorMac_class->resolve = JS_ResolveStub;
	JSB_CCDirectorMac_class->convert = JS_ConvertStub;
	JSB_CCDirectorMac_class->finalize = JSB_CCDirectorMac_finalize;
	JSB_CCDirectorMac_class->flags = 0;

	static JSPropertySpec properties[] = {
		{0, 0, 0, 0, 0}
	};
	static JSFunctionSpec funcs[] = {
		JS_FN("convertToLogicalCoordinates", JSB_CCDirectorMac_convertToLogicalCoordinates_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getIsFullScreen", JSB_CCDirectorMac_isFullScreen, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getOriginalWinSize", JSB_CCDirectorMac_originalWinSize, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getResizeMode", JSB_CCDirectorMac_resizeMode, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setFullScreen", JSB_CCDirectorMac_setFullScreen_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setOriginalWinSize", JSB_CCDirectorMac_setOriginalWinSize_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setResizeMode", JSB_CCDirectorMac_setResizeMode_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
		JS_FN("sharedDirector", JSB_CCDirectorMac_sharedDirector_static, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FS_END
	};

	JSB_CCDirectorMac_object = JS_InitClass(cx, globalObj, JSB_CCDirector_object, JSB_CCDirectorMac_class, JSB_CCDirectorMac_constructor,0,properties,funcs,NULL,st_funcs);
	JSBool found;
	JS_SetPropertyAttributes(cx, globalObj, name, JSPROP_ENUMERATE | JSPROP_READONLY, &found);
}

@implementation JSB_CCDirectorMac

+(JSObject*) createJSObjectWithRealObject:(id)realObj context:(JSContext*)cx
{
	JSObject *jsobj = JS_NewObject(cx, JSB_CCDirectorMac_class, JSB_CCDirectorMac_object, NULL);
	JSB_CCDirectorMac *proxy = [[JSB_CCDirectorMac alloc] initWithJSObject:jsobj class:[CCDirectorMac class]];
	[proxy setRealObj:realObj];
...
JSBool JSB_CCLayer_gesturePriority(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: BOOL (b)
JSBool JSB_CCLayer_isGestureEnabled(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: BOOL (b)
JSBool JSB_CCLayer_isKeyboardEnabled(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: BOOL (b)
JSBool JSB_CCLayer_isMouseEnabled(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: NSInteger (i)
JSBool JSB_CCLayer_keyboardPriority(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: NSInteger (i)
JSBool JSB_CCLayer_mousePriority(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: BOOL
// Ret value: void (None)
JSBool JSB_CCLayer_setGestureEnabled_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCLayer *real = (CCLayer*) [proxy realObj];
	[real setGestureEnabled:(BOOL)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: NSInteger
// Ret value: void (None)
JSBool JSB_CCLayer_setGesturePriority_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCLayer *real = (CCLayer*) [proxy realObj];
	[real setGesturePriority:(NSInteger)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: BOOL
// Ret value: void (None)
JSBool JSB_CCLayer_setKeyboardEnabled_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCLayer *real = (CCLayer*) [proxy realObj];
	[real setKeyboardEnabled:(BOOL)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: NSInteger
// Ret value: void (None)
JSBool JSB_CCLayer_setKeyboardPriority_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCLayer *real = (CCLayer*) [proxy realObj];
	[real setKeyboardPriority:(NSInteger)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: BOOL
// Ret value: void (None)
JSBool JSB_CCLayer_setMouseEnabled_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCLayer *real = (CCLayer*) [proxy realObj];
	[real setMouseEnabled:(BOOL)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: NSInteger
// Ret value: void (None)
JSBool JSB_CCLayer_setMousePriority_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCLayer *real = (CCLayer*) [proxy realObj];
	[real setMousePriority:(NSInteger)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: NSEvent*
// Ret value: void (None)
JSBool JSB_CCLayer_ccMouseEntered_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: void (None)
JSBool JSB_CCLayer_ccMouseExited_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccMouseMoved_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccOtherMouseDown_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccOtherMouseDragged_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccOtherMouseUp_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccRightMouseDown_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccRightMouseDragged_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccRightMouseUp_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccScrollWheel_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccTouchesBeganWithEvent_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccTouchesCancelledWithEvent_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccTouchesEndedWithEvent_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: NSEvent*
// Ret value: BOOL (b)
JSBool JSB_CCLayer_ccTouchesMovedWithEvent_(JSContext *cx, uint32_t argc, jsval *vp) {
...
void JSB_CCLayer_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("getGesturePriority", JSB_CCLayer_gesturePriority, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("isGestureEnabled", JSB_CCLayer_isGestureEnabled, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("isKeyboardEnabled", JSB_CCLayer_isKeyboardEnabled, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("isMouseEnabled", JSB_CCLayer_isMouseEnabled, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("isTouchEnabled", JSB_CCLayer_isTouchEnabled, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getKeyboardPriority", JSB_CCLayer_keyboardPriority, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getMousePriority", JSB_CCLayer_mousePriority, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setGestureEnabled", JSB_CCLayer_setGestureEnabled_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setGesturePriority", JSB_CCLayer_setGesturePriority_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setKeyboardEnabled", JSB_CCLayer_setKeyboardEnabled_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setKeyboardPriority", JSB_CCLayer_setKeyboardPriority_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setMouseEnabled", JSB_CCLayer_setMouseEnabled_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setMousePriority", JSB_CCLayer_setMousePriority_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		...
		JS_FN("getTouchPriority", JSB_CCLayer_touchPriority, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccMouseEntered", JSB_CCLayer_ccMouseEntered_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccMouseExited", JSB_CCLayer_ccMouseExited_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccMouseMoved", JSB_CCLayer_ccMouseMoved_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccOtherMouseDown", JSB_CCLayer_ccOtherMouseDown_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccOtherMouseDragged", JSB_CCLayer_ccOtherMouseDragged_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccOtherMouseUp", JSB_CCLayer_ccOtherMouseUp_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccRightMouseDown", JSB_CCLayer_ccRightMouseDown_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccRightMouseDragged", JSB_CCLayer_ccRightMouseDragged_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccRightMouseUp", JSB_CCLayer_ccRightMouseUp_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccScrollWheel", JSB_CCLayer_ccScrollWheel_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("ccTouchesBeganWithEvent", JSB_CCLayer_ccTouchesBeganWithEvent_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
...
void JSB_CCLayerColor_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("init", JSB_CCLayerColor_initWithColor_width_height_, 3, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
