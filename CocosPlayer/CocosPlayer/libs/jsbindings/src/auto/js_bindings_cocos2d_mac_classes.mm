...
JSBool JSB_CCLayer_keyboardDelegatePriority(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: NSInteger (i)
JSBool JSB_CCLayer_mouseDelegatePriority(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: BOOL
// Ret value: void (None)
JSBool JSB_CCLayer_setIsKeyboardEnabled_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: BOOL
// Ret value: void (None)
JSBool JSB_CCLayer_setIsMouseEnabled_(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: NSInteger (i)
JSBool JSB_CCLayer_touchDelegatePriority(JSContext *cx, uint32_t argc, jsval *vp) {
...
void JSB_CCLayer_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("getIsKeyboardEnabled", JSB_CCLayer_isKeyboardEnabled, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getMouseEnabled", JSB_CCLayer_isMouseEnabled, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getIsTouchEnabled", JSB_CCLayer_isTouchEnabled, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("keyboardDelegatePriority", JSB_CCLayer_keyboardDelegatePriority, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("mouseDelegatePriority", JSB_CCLayer_mouseDelegatePriority, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setIsKeyboardEnabled", JSB_CCLayer_setIsKeyboardEnabled_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setMouseEnabled", JSB_CCLayer_setIsMouseEnabled_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setIsTouchEnabled", JSB_CCLayer_setIsTouchEnabled_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("touchDelegatePriority", JSB_CCLayer_touchDelegatePriority, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
