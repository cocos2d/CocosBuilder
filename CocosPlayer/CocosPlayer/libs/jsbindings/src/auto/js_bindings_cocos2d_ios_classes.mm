...
void JSB_CCLayer_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("getTouchMode", JSB_CCLayer_touchMode, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("getTouchPriority", JSB_CCLayer_touchPriority, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("onTouchEnded", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("onTouchBegan", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("onTouchMoved", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("onTouchesEnded", JSB_do_nothing, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
...
-(void) ccTouchEnded:(UITouch*)touch withEvent:(UIEvent*)event 
{
	if (_jsObj) {
		...
		if (found == JS_TRUE) {
			...
			unsigned argc=2;
			jsval argv[2];
			argv[0] = NSObject_to_jsval( cx, touch );
			argv[1] = NSObject_to_jsval( cx, event );
