...
JS_DefineFunction(_cx, chipmunk, "bodyAlloc", JSB_cpBodyAlloc, 0, JSPROP_READONLY | JSPROP_PERMANENT | JSPROP_ENUMERATE );
...
JS_DefineFunction(_cx, chipmunk, "spaceAlloc", JSB_cpSpaceAlloc, 0, JSPROP_READONLY | JSPROP_PERMANENT | JSPROP_ENUMERATE );
